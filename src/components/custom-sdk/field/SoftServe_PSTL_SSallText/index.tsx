...
import StyledSoftServePstlSSallTextWrapper from './styles';
...
export default function SoftServePstlSSallText(props: any) {
  const {
    label,
    required,
    disabled,
  ...
  return (
    <StyledSoftServePstlSSallTextWrapper>
     <TextField
      fullWidth
...
SoftServePstlSSallText.defaultProps = {
  value: '',
  placeholder: '',
  validatemessage: '',
  helperText: '',
...
SoftServePstlSSallText.propTypes = {
