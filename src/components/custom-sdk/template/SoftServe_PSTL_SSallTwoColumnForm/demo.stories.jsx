...
import SoftServePstlSSallTwoColumnForm from './index.tsx';
...
export default {
  title: 'SoftServePstlSSallTwoColumnForm',
  component: SoftServePstlSSallTwoColumnForm
};
...
export const BaseSoftServePstlSSallTwoColumnForm = () => {
  ...
  return (
    <>
      <SoftServePstlSSallTwoColumnForm {...props}>
        {regionAChildren}
        {regionBChildren}
      </SoftServePstlSSallTwoColumnForm>
    </>
  );
};
