...
import StyledSoftServePstlSSallTwoColumnDetailsWrapper from './styles';
...
export default function SoftServePstlSSallTwoColumnDetails(props) {
  ...
  return (
    <StyledSoftServePstlSSallTwoColumnDetailsWrapper>
...
SoftServePstlSSallTwoColumnDetails.defaultProps = {
  label: undefined,
  showLabel: true,
...
SoftServePstlSSallTwoColumnDetails.propTypes = {
