...
import SoftServePstlSSallForm from './index.jsx';
...
export default {
  title: 'SoftServePstlSSallForm',
  decorators: [withKnobs],
  component: SoftServePstlSSallForm
};
...
export const baseSoftServePstlSSallForm = () => {
  const props = {
    NumCols: 1,
  ...
  return (
      <>
        <SoftServePstlSSallForm {...props}>{regionAChildren}</SoftServePstlSSallForm>
      </>
  );
};
