...
import StyledSoftServePstlSSallCaseWidgetWrapper from './styles';
...
export default function SoftServePstlSSallCaseWidget(props) {
  ...
  return (
    <StyledSoftServePstlSSallCaseWidgetWrapper>
    <Table
...
SoftServePstlSSallCaseWidget.defaultProps = {

};

SoftServePstlSSallCaseWidget.propTypes = {
