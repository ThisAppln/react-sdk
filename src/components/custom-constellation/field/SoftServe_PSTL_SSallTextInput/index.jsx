...
const SoftServePstlSSallTextInput = props => {
 const {
    getPConnect,
    placeholder,
    validatemessage,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledSoftServePstlSSallTextInputWrapper> displayComp </StyledSoftServePstlSSallTextInputWrapper>
    ) : (
...
export default SoftServePstlSSallTextInput;
