...
const SoftServePstlSSallDateTime = props => {
  const {
    getPConnect,
    value,
    validatemessage,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return ( <StyledSoftServePstlSSallDateTimeWrapper> displayComp </StyledSoftServePstlSSallDateTimeWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
...
export default SoftServePstlSSallDateTime;
