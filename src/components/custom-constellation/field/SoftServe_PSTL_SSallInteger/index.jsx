...
const SoftServePstlSSallInteger = props => {
  const {
    getPConnect,
    value,
    defaultValue,
  ...
  if (['LABELS_LEFT', 'STACKED_LARGE_VAL', 'DISPLAY_ONLY'].includes(displayMode)) {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledSoftServePstlSSallIntegerWrapper> displayComp </StyledSoftServePstlSSallIntegerWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
...
export default SoftServePstlSSallInteger;
