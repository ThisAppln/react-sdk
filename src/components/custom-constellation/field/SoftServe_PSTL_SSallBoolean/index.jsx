...
const SoftServePstlSSallBoolean = props => {
  const {
    getPConnect,
    value,
    label,
  ...
  if (displayMode) {
    displayComponent = <SoftServePstlSSallBoolean  value={value} trueLabel={trueLabel} falseLabel={falseLabel} />;
  }

  if (displayMode === 'DISPLAY_ONLY') {
    return ( <StyledSoftServePstlSSallBooleanWrapper> displayComponent </StyledSoftServePstlSSallBooleanWrapper>);
  }
...
export default SoftServePstlSSallBoolean;
