...
import StyledSoftServePstlSSallPercentageWrapper from './styles';
...
const SoftServePstlSSallPercentage = props => {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledSoftServePstlSSallPercentageWrapper>
      displayComp
      </StyledSoftServePstlSSallPercentageWrapper>
    ) : (
      <StyledSoftServePstlSSallPercentageWrapper>
...
SoftServePstlSSallPercentage.defaultProps = {
  value: '',
  placeholder: '',
  validatemessage: '',
  helperText: '',
...
SoftServePstlSSallPercentage.propTypes = {
...
export default SoftServePstlSSallPercentage;
