...
const SoftServePstlSSallDate = props => {
  const {
    getPConnect,
    value,
    validatemessage,
 ...
 let { readOnly, required, disabled } = props;
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch(displayMode){
      case 'DISPLAY_ONLY': {
        return ( <StyledSoftServePstlSSallDateWrapper> displayComp </StyledSoftServePstlSSallDateWrapper>);
      }
      case "LABELS_LEFT" : {
        return (
...
export default SoftServePstlSSallDate;
