...
const SoftServePstlSSallDecimal = props => {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  if (['DISPLAY_ONLY', 'LABELS_LEFT', 'STACKED_LARGE_VAL'].includes(displayMode)) {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledSoftServePstlSSallDecimalWrapper> displayComp </StyledSoftServePstlSSallDecimalWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
...
export default SoftServePstlSSallDecimal;
