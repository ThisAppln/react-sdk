...
const SoftServePstlSSallCurrency = props => {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledSoftServePstlSSallCurrencyWrapper> displayComp </StyledSoftServePstlSSallCurrencyWrapper>) ;
      }
      case 'LABELS_LEFT': {
        return (
...
export default SoftServePstlSSallCurrency;
